...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  listCredentials: (browserId) => ipcRenderer.invoke('credentials:list', browserId),
  getCredential: (account) => ipcRenderer.invoke('credentials:get', account),
  removeCredential: (account) => ipcRenderer.invoke('credentials:remove', account),
